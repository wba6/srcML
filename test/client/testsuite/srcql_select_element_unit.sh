...
#
# @file srcql_select_element_unit.sh
#
...
srcml sub/a.cpp.xml --srcql '$C($N)' --xpath="//src:argument/src:expr/src:name"
check "$output"

srcml --srcql '$C($N)' --xpath "//src:argument/src:expr/src:name" sub/a.cpp.xml
check "$output"

srcml sub/a.cpp.xml --srcql '$C($N)' --xpath "//src:argument/src:expr/src:name" -o sub/a.xml
check sub/a.xml "$output"

srcml --srcql '$C($N)' --xpath "//src:argument/src:expr/src:name" sub/a.cpp.xml -o sub/a.xml
check sub/a.xml "$output"

srcml sub/a.cpp.xml -o sub/a.xml --srcql '$C($N)' --xpath "//src:argument/src:expr/src:name"
check sub/a.xml "$output"

srcml -o sub/a.xml sub/a.cpp.xml --srcql '$C($N)' --xpath "//src:argument/src:expr/src:name"
check sub/a.xml "$output"
...
# srcml sub/a.cpp.xml --srcql '$N' --xpath "(//src:name)[1]"
# check "$output"

# srcml --srcql '$C($N)' --xpath "(//src:name)[1]" sub/a.cpp.xml
# check "$output"

# srcml sub/a.cpp.xml --srcql '$C($N)' --xpath "(//src:name)[1]" -o sub/a.xml
# check sub/a.xml "$output"

# srcml sub/a.cpp.xml -o sub/a.xml --srcql '$C($N)' --xpath "(//src:name)[1]"
# check sub/a.xml "$output"

# srcml -o sub/a.xml sub/a.cpp.xml --srcql '$C($N)' --xpath "(//src:name)[1]"
# check sub/a.xml "$output"

# srcml -o sub/a.xml --srcql '$C($N)' --xpath "(//src:name)[1]" sub/a.cpp.xml
# check sub/a.xml "$output"

# srcml --srcql '$C($N)' --xpath "(//src:name)[1]" -o sub/a.xml sub/a.cpp.xml
# check sub/a.xml "$output"
...
# srcml sub/a.cpp.xml --srcql '$C($N)' --xpath "//src:type/src:name/text()"
# check "$output"

# srcml --srcql '$C($N)' --xpath "//src:type/src:name/text()" sub/a.cpp.xml
# check "$output"

# srcml sub/a.cpp.xml --srcql '$C($N)' --xpath "//src:type/src:name/text()" -o sub/a.xml
# check sub/a.xml "$output"

# srcml sub/a.cpp.xml -o sub/a.xml --srcql '$C($N)' --xpath "//src:type/src:name/text()"
# check sub/a.xml "$output"

# srcml -o sub/a.xml sub/a.cpp.xml --srcql '$C($N)' --xpath "//src:type/src:name/text()"
# check sub/a.xml "$output"

# srcml -o sub/a.xml --srcql '$C($N)' --xpath "//src:type/src:name/text()" sub/a.cpp.xml
# check sub/a.xml "$output"

# srcml --srcql '$C($N)' --xpath "//src:type/src:name/text()" -o sub/a.xml sub/a.cpp.xml
# check sub/a.xml "$output"

# srcml --srcql '$C($N)' --xpath "//src:type/src:name/text()" sub/a.cpp.xml -o sub/a.xml
# check sub/a.xml "$output"
