...
# Package filenames
set(BASE_SRCML_FILE_NAME "${CPACK_DEBIAN_SRCML_PACKAGE_NAME}_${PROJECT_VERSION}-${CPACK_DEBIAN_PACKAGE_RELEASE}_${DEBIAN_VERSION}_${SRCML_SYSTEM_ARCHITECTURE}")
set(BASE_DEVLIBS_FILE_NAME "${CPACK_DEBIAN_DEVLIBS_PACKAGE_NAME}_${PROJECT_VERSION}-${CPACK_DEBIAN_PACKAGE_RELEASE}_${DEBIAN_VERSION}_${SRCML_SYSTEM_ARCHITECTURE}")
