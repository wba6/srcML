...
start_python[] {
        ...
        */
        ...
        constexpr size_t DUPLEX_RULES_SIZE = 700;
        ...
        constexpr int PY_EXCEPT_MULTOPS = DUPLEX_RULES_SIZE + 100;
        constexpr int PY_YIELD_PY_FROM = DUPLEX_RULES_SIZE + 101;
        ...
        constexpr size_t PYTHON_RULES_SIZE = DUPLEX_RULES_SIZE + 200;
