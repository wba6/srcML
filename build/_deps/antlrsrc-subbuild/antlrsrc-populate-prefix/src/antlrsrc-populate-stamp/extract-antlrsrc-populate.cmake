...
#
get_filename_component(filename "/home/runner/work/srcML/srcML/build/_deps/antlrsrc-subbuild/antlrsrc-populate-prefix/src/antlr-2.7.7.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/srcML/srcML/build/_deps/antlrsrc-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-antlrsrc-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-antlrsrc-populate${i}")
